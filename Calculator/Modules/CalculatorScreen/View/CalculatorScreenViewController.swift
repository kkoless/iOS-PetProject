...
final class GeneralScreenViewController: UIViewController {
    ...
    private var presenter: GeneralScreenPresenter?
    ...
    private func setupNumberPad() {
        ...
        zeroButton.titleLabel?.font = UIFont(name: "Helvetica", size: 25)
        zeroButton.tag = 1
        backgroundView.addSubview(zeroButton)
        ...
        clearButton.titleLabel?.font = UIFont(name: "Helvetica", size: 21)
        ...
        for x in 0..<5 {
            let button_operand = UIButton(frame: CGRect(x: buttonSize * 3, y: view.frame.size.height - (buttonSize * CGFloat(x + 1)), width: buttonSize, height: buttonSize))
            ...
            button_operand.titleLabel?.font = UIFont(name: "Helvetica", size: 25)
            backgroundView.addSubview(button_operand)
